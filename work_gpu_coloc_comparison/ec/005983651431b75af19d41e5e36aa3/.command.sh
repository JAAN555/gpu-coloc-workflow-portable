...
echo "comparison_id: de_Lange_2017_m1e6_vs_exon" > "de_Lange_2017_m1e6_vs_exon.log"
echo "gwas_name: de_Lange_2017_m1e6" >> "de_Lange_2017_m1e6_vs_exon.log"
echo "eqtl_name: exon" >> "de_Lange_2017_m1e6_vs_exon.log"
echo "dir1: /gpfs/helios/home/jaanotte/gpu-coloc-workflow-portable/nf_out_prepare_de_lange_parquets_modular_36_fillminus1e6/03_gwas_grouped_root/gwas_grouped" >> "de_Lange_2017_m1e6_vs_exon.log"
echo "dir2: /gpfs/helios/projects/shared_gwas/gpu-coloc_resources/eQTL_Catalogue/exon_parquets" >> "de_Lange_2017_m1e6_vs_exon.log"
echo "p12: 1e-6" >> "de_Lange_2017_m1e6_vs_exon.log"
echo "H4: 0.8" >> "de_Lange_2017_m1e6_vs_exon.log"
echo "task_host: $(hostname)" >> "de_Lange_2017_m1e6_vs_exon.log"
echo "task_start: $(date)" >> "de_Lange_2017_m1e6_vs_exon.log"
echo "Matched chromosomes:" >> "de_Lange_2017_m1e6_vs_exon.log"
...
comm -12 \
  ...
  >> "de_Lange_2017_m1e6_vs_exon.log" || true
...
/usr/bin/time -v python3 /gpfs/helios/home/jaanotte/gpu-coloc-workflow-portable/gpu_coloc/coloc.py \
  ...
  --results "de_Lange_2017_m1e6_vs_exon.tsv" \
  --p12 "1e-6" \
  --H4 "0.8" \
  >> "de_Lange_2017_m1e6_vs_exon.log" 2> "de_Lange_2017_m1e6_vs_exon.time"

echo "task_end: $(date)" >> "de_Lange_2017_m1e6_vs_exon.log"

if [[ ! -s "de_Lange_2017_m1e6_vs_exon.tsv" ]]; then
  echo -e "PP.H3\tPP.H4\tsignal1\tlead1\tsignal2\tlead2" > "de_Lange_2017_m1e6_vs_exon.tsv"
fi

test -s "de_Lange_2017_m1e6_vs_exon.tsv"
test -s "de_Lange_2017_m1e6_vs_exon.log"
test -s "de_Lange_2017_m1e6_vs_exon.time"
