...
echo "comparison_id: Suzuki_Aragam_vs_tx" > "Suzuki_Aragam_vs_tx.log"
echo "gwas_name: Suzuki_Aragam" >> "Suzuki_Aragam_vs_tx.log"
echo "eqtl_name: tx" >> "Suzuki_Aragam_vs_tx.log"
echo "dir1: /gpfs/helios/projects/shared_gwas/gpu-coloc_resources/Suzuki_Aragam_parquets" >> "Suzuki_Aragam_vs_tx.log"
echo "dir2: /gpfs/helios/projects/shared_gwas/gpu-coloc_resources/eQTL_Catalogue/tx_parquets" >> "Suzuki_Aragam_vs_tx.log"
echo "p12: 1e-6" >> "Suzuki_Aragam_vs_tx.log"
echo "H4: 0.8" >> "Suzuki_Aragam_vs_tx.log"
echo "task_host: $(hostname)" >> "Suzuki_Aragam_vs_tx.log"
echo "task_start: $(date)" >> "Suzuki_Aragam_vs_tx.log"
echo "Matched chromosomes:" >> "Suzuki_Aragam_vs_tx.log"
...
/usr/bin/time -v python3 /gpfs/helios/home/jaanotte/gpu-coloc-workflow-portable/gpu_coloc/coloc.py \
  ...
  --results "Suzuki_Aragam_vs_tx.tsv" \
  --p12 "1e-6" \
  --H4 "0.8" \
  >> "Suzuki_Aragam_vs_tx.log" 2> "Suzuki_Aragam_vs_tx.time"

echo "task_end: $(date)" >> "Suzuki_Aragam_vs_tx.log"

if [[ ! -s "Suzuki_Aragam_vs_tx.tsv" ]]; then
  echo -e "PP.H3\tPP.H4\tsignal1\tlead1\tsignal2\tlead2" > "Suzuki_Aragam_vs_tx.tsv"
fi

test -s "Suzuki_Aragam_vs_tx.tsv"
test -s "Suzuki_Aragam_vs_tx.log"
test -s "Suzuki_Aragam_vs_tx.time"
