...
echo "comparison_id: Astle_2016_m1e6_vs_txrev" > "Astle_2016_m1e6_vs_txrev.log"
echo "gwas_name: Astle_2016_m1e6" >> "Astle_2016_m1e6_vs_txrev.log"
echo "eqtl_name: txrev" >> "Astle_2016_m1e6_vs_txrev.log"
echo "dir1: /gpfs/helios/home/jaanotte/gpu-coloc-workflow-portable/nf_out_prepare_astle_parquets_modular_36_fillminus1e6/03_gwas_grouped_root/gwas_grouped" >> "Astle_2016_m1e6_vs_txrev.log"
echo "dir2: /gpfs/helios/projects/shared_gwas/gpu-coloc_resources/eQTL_Catalogue/txrev_parquets" >> "Astle_2016_m1e6_vs_txrev.log"
echo "p12: 1e-6" >> "Astle_2016_m1e6_vs_txrev.log"
echo "H4: 0.8" >> "Astle_2016_m1e6_vs_txrev.log"
echo "task_host: $(hostname)" >> "Astle_2016_m1e6_vs_txrev.log"
echo "task_start: $(date)" >> "Astle_2016_m1e6_vs_txrev.log"
echo "Matched chromosomes:" >> "Astle_2016_m1e6_vs_txrev.log"
...
comm -12 \
  ...
  >> "Astle_2016_m1e6_vs_txrev.log" || true
...
/usr/bin/time -v python3 /gpfs/helios/home/jaanotte/gpu-coloc-workflow-portable/gpu_coloc/coloc.py \
  ...
  --results "Astle_2016_m1e6_vs_txrev.tsv" \
  --p12 "1e-6" \
  --H4 "0.8" \
  >> "Astle_2016_m1e6_vs_txrev.log" 2> "Astle_2016_m1e6_vs_txrev.time"

echo "task_end: $(date)" >> "Astle_2016_m1e6_vs_txrev.log"

if [[ ! -s "Astle_2016_m1e6_vs_txrev.tsv" ]]; then
  echo -e "PP.H3\tPP.H4\tsignal1\tlead1\tsignal2\tlead2" > "Astle_2016_m1e6_vs_txrev.tsv"
fi

test -s "Astle_2016_m1e6_vs_txrev.tsv"
test -s "Astle_2016_m1e6_vs_txrev.log"
test -s "Astle_2016_m1e6_vs_txrev.time"
