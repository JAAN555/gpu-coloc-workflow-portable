...
echo "comparison_id: FinnGen_vs_exon" > "FinnGen_vs_exon.log"
echo "gwas_name: FinnGen" >> "FinnGen_vs_exon.log"
echo "eqtl_name: exon" >> "FinnGen_vs_exon.log"
echo "dir1: /gpfs/helios/projects/shared_gwas/gpu-coloc_resources/FinnGen_lbf_parquets" >> "FinnGen_vs_exon.log"
echo "dir2: /gpfs/helios/projects/shared_gwas/gpu-coloc_resources/eQTL_Catalogue/exon_parquets" >> "FinnGen_vs_exon.log"
echo "p12: 1e-6" >> "FinnGen_vs_exon.log"
echo "H4: 0.8" >> "FinnGen_vs_exon.log"
echo "task_host: $(hostname)" >> "FinnGen_vs_exon.log"
echo "task_start: $(date)" >> "FinnGen_vs_exon.log"
echo "Matched chromosomes:" >> "FinnGen_vs_exon.log"
...
/usr/bin/time -v python3 /gpfs/helios/home/jaanotte/gpu-coloc-workflow-portable/gpu_coloc/coloc.py \
  ...
  --results "FinnGen_vs_exon.tsv" \
  --p12 "1e-6" \
  --H4 "0.8" \
  >> "FinnGen_vs_exon.log" 2> "FinnGen_vs_exon.time"

echo "task_end: $(date)" >> "FinnGen_vs_exon.log"

if [[ ! -s "FinnGen_vs_exon.tsv" ]]; then
  echo -e "PP.H3\tPP.H4\tsignal1\tlead1\tsignal2\tlead2" > "FinnGen_vs_exon.tsv"
fi

test -s "FinnGen_vs_exon.tsv"
test -s "FinnGen_vs_exon.log"
test -s "FinnGen_vs_exon.time"
