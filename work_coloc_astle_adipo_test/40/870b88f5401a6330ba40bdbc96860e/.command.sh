...
set -euo pipefail
  ...
  export GWAS_ROOTS='Astle_2016_m1e6=/gpfs/helios/home/jaanotte/gpu-coloc-workflow-portable/nf_out_prepare_astle_parquets_modular_36_fillminus1e6/03_gwas_grouped_root/gwas_grouped'
  export EQTL_ROOTS='AdipoExpress=/gpfs/helios/home/jaanotte/gpu-coloc-workflow-portable/nf_out_prepare_adipoexpress_eqtl_parquets/03_eqtl_grouped_root/eqtl_grouped'
  export P12='1e-6'
  export H4='0.8'
